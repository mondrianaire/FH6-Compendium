...
- Recent state: `docs/handoff-2026-09-18-ab-testing-groundwork.md` (the confidence gate, the
  deterministic detectors, the slider sweep protocol — **read before touching diagnosis or adding a
  detector**), `docs/handoff-2026-09-18-test-suite-repair.md` (schema.sql repair + the objectmodel
  name guard), `docs/handoff-2026-09-11-course-mode-live-pedals.md`, `docs/handoff-2026-09-06-session-state.md`
