...
(function () {
  ...
  function buildLab() {
    ...
    const courseBlock = (co, s) => {
      ...
      const tr = co.track; const carLabel = (c) => `${c.name || "#" + String(c.cid).split("|")[0]} · ${c.class || ""} ${c.pi || ""}`.trim();
      const trackCard = tr ? `<div style="margin:8px 0;padding:8px 10px;border:1px solid var(--accent2);border-radius:8px;background:var(--bg2)">
      ...
      return `<div class="lab-corner" style="border-left:4px solid var(--accent2)">
        ...
        ${trackCard}${profileCard}${co.geometry ? `<div style="margin:8px 0;padding:8px 10px;border:1px solid var(--line);border-radius:8px;background:var(--bg2)">
