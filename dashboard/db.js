    ...
    "tracks": [
      {
        ...
        "how_to_get_the_tune": "616 PI is NOT a searchable tune — it was a bespoke under-cap build by leaderboard drivers; the Tune Browser can't filter by exact PI and almost everyone shares tunes built to the class cap (A 700). To source a tune: (1) BEST — on the Rivals leaderboard, select the fast Supra time (#1 or the #4 at 616) and view/download THEIR tune (if shared) for the exact build; or (2) EASIEST — Tune Browser > search 2020 GR Supra > filter A class > sort by most-downloaded/highest-rated > pick a top one (it'll be ~A 700, which is perfectly competitive on this soft board). '616' just means grip-focused/don't over-power — not a hard target.",
        "targets": {
