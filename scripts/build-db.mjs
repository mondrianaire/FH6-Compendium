...
console.log(`Wrote dashboard/db.js (${db.metaCars.cars.length} cars, ${db.tuningVariables.categories.length} tuning categories, ${db.rivalsTracks.tracks.length} rivals tracks)`);
